...
/**
 * This controller will handle user login and return JWT tokens.
 */
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest request){
        ...
        // returning the JWT along with user information and roles.
...
/*
* @Valid: This annotation validates the LoginRequest fields (such as checking that email
* and password are not empty or malformed).
*
*
* */
